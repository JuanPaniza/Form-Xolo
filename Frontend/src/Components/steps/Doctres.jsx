function Doctres({handleChange, handleKeyUp, checkState, inputRealTimeValidation, handleClick, errorForm}) {
  const questionsTres = [
    {
      id: 1,
      label:
      ...
      inputText: { value: "SkintreatmentInput", label: "Mention what they are?"},
    },
    {
      id: 2,
      ...
      inputText: { value: "ChokinproductsInput", label: "Mention what they are?" },
    },
  ];
        ...
        {questionsTres.map((question) => (
          <div key={question.id}>
            <div className="mt-7">
              ...
              <div>
                {question.options !== "" && <div className="flex gap-3 mt-7">
